...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:PPD-Phase2Spring24DIGIRECOMiniAOD-00021_0.root'),
...
process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_RECO'); process.MINIAODSIMoutput.outputCommands.append('keep *_*_*_SIM');
